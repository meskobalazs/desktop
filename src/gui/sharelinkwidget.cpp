...
ShareLinkWidget::ShareLinkWidget(AccountPtr account,
    ...
    , _shareLinkLayout(nullptr)
    , _shareLinkLabel(nullptr)
    , _shareLinkEdit(nullptr)
    , _shareLinkButton(nullptr)
    , _shareLinkProgressIndicator(nullptr)
    , _shareLinkDefaultWidget(nullptr)
    , _shareLinkWidgetAction(nullptr)
{
    _ui->setupUi(this);
